...
朋友打开页面先选想约的事（吃饭、逛街、拍照、cos、旅行……），日历只亮出这件事能约的日子和时段。项目在 `settings.html` 的「项目」表里设置，每一行是「谁、休息日 / 工作日、什么时段、提前多久」，同一个项目可以有好几行。默认：

| 项目 | 谁 | 日子与时段 | 提前 |
| --- | --- | --- | --- |
| 吃饭 | 朋友 | 休息日 14:00–18:00 | 1 天 |
| 吃饭 | 标签「住得近」 | 工作日 18:30–20:00 | 2 小时 |
| 逛街 | 朋友 | 休息日 14:00–18:00 | 1 天 |
| 拍照 | 圈内好友 | 休息日 14:00–18:00 | 1 天 |
| cos | 圈内好友、密友 | 任何日子，不选时段 | 30 天 |
| 旅行 | 密友 | 休息日，不选时段 | 14 天 |
| 吃饭 / 逛街 / 拍照 | 密友 | 休息日 10:00–21:00，工作日 18:30–21:00 | 2 小时 |

没亮的日子只要没有大安排，都显示「可以商量」，点开能直接生成「时间可以商量吗？」的消息。标签（比如「住得近」）在生成分享码时按人添加。半开放日（能看到名字的人）按那天的时段约；全天半开放日用设置页里的「全天半开放日的见面时段」。

全天事件写「调休」这天按休息日算，写「补班」按工作日算（词可以在设置页改）。
...
| `elder` 长辈 | 只显示「空闲 / 上班 / 有安排 / 回老家」，没有时段、活动类型和约饭选项 | |
| `con` 漫展圈 | 在 xx | 不可用 |
| `close` 密友 | 在 xx | 回老家 |
